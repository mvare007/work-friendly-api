...
Doorkeeper.configure do
  ...
  #
  allow_blank_redirect_uri true # user won’t get redirected after login, as we are using API
  #
  ...
  skip_authorization do |_resource_owner, _client|
    true # As the OAuth application we create is for our own use (not third part), we can skip authorization.
  end
